...
- from the previous month, the _class_ name will be <code>monthPrev</code>
- from the next month, the _class_ name will be <code>monthNext</code>
- the current day, the _class_ name will be <code>today</code>
- any other day of the month, the _class_ name will be <code>daily</code>
